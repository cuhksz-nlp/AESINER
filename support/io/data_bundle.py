...
class DataBundle:
    ...
    def __init__(self, vocabs: dict = None, datasets: dict = None):
        ...
        :param vocabs: 从名称(字符串)到 :class:`~support.Vocabulary` 类型的dict
        :param datasets: 从名称(字符串)到 :class:`~support.DataSet` 类型的dict
        """
    ...
    def set_vocab(self, vocab, field_name):
        ...
        :param ~support.Vocabulary vocab: 词表
        :param str field_name: 这个vocab对应的field名称
        :return: self
        """
        assert isinstance(vocab, Vocabulary), "Only support.Vocabulary supports."
    ...
    def set_dataset(self, dataset, name: str):
        ...
        :param ~support.DataSet dataset: 传递给DataBundle的DataSet
        :param str name: dataset的名称
        :return: self
        """
        assert isinstance(dataset, DataSet), "Only support.DataSet supports."
