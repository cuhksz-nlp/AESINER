    ...
    def __init__(self, train_data, model, optimizer=None, loss=None,
        ...
        if self.dev_data is not None:
            self.tester = Tester(model=self.model,
                                 ...
                                 zen_dataset=self.zen_dev_dataset
                                 )
    ...
    def get_chunk_mask_matrix(self, indices, seq_len):
        ...
        for index in indices:
            ...
            for item in feature_data:
                ...
                # ret.append([0] * (start - 1) + [1] * (end - start + 1) + [0] * (seq_len - end))
    ...
    def get_zen_data(self, indices, max_seq_len):
        ...
        with torch.no_grad():
            output, _ = self.zen_model(input_ids=batch_input_ids, input_ngram_ids=batch_ngram_ids,
                                       ...
                                       attention_mask=batch_attention_mask, ngram_attention_mask=batch_ngram_attention_mask,
        ...
        with inner_tqdm(total=self.n_steps, postfix='loss:{0:<6.5f}', leave=False, dynamic_ncols=True) as pbar:
            ...
            for epoch in range(1, self.n_epochs + 1):
                ...
                for indices, batch_x, batch_y in data_iterator:
                    ...
                    # 为了attack，暂时修改下这里，修改的地方为把下一行注释了
